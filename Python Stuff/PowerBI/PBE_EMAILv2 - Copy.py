...
data_error = """
    <div>
        ...
        <span style="font-family: 'Calibri'; font-size: 14; color: #000000;">
            ...
            Hi all, <br>
                Logic still not working properly, but review the two screen shots to see if there are changes.
             <br>
    ...
    <div>
 	...
 	Current Screen Shot <br>
        <img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\morning.png" width=10%>

	Previous Screen Shot <br>
        <img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\arvo.png" width=10%>  <br>
