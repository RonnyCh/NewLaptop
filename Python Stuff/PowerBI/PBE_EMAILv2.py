...
>link</a> to access the Growth Campaign Tracker report. 
    ...
    <div>
	Latest data <br>
        <img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\mypng.png" width=10%> <br> <br>
	Previous data <br> <br>
	<img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\arvo.png" width=10%>
...
###################################### Email If Data has not been refreshed (*** not working properly ****)##############################################
data_error = """
    <div>
        <h1 style="font-family: 'Calibri'; font-size: 17; font-weight: bold; color: #000000;">
        ...
        <span style="font-family: 'Calibri'; font-size: 14; color: #000000;">
            ...
            Hi all, <br>
                Please see below two screen shots comparing yesterday and this morning.
             <br>
    ...
    <div>
 	...
 	This Morning Screen Shot <br>
        <img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\morning.png" width=50%> <br>

	Yesterday Screen Shot <br>
        <img src="C:\\Users\\m118954\\OneDrive - Westpac Group\\_sharing\\Power BI Email\\arvo.png" width=50%>  <br>
...
myteam = 'ronny.christianto@westpac.com.au;norman.yan@westpac.com.au;annie.liao@westpac.com.au'
...
if me is not None:	
	...
	mail.BCC = ''
	mail.Subject = 'Comparison for the last 2 days'
	...
	mail.To = myteam    # use ; to add more names
	mail.BCC = ''
	mail.Subject = 'Please Review Ready to Send'
