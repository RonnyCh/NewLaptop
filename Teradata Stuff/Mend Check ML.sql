...
sum(case when reporting_mth = '201806' then metric_amt else 0 end) as P1,
sum(case when reporting_mth = '201807' then metric_amt else 0 end) as P2
...
and reporting_mth in  ('201806','201807')
and manual_alloc_desc in ('Bill Reclass Issue','BS Issue Prod Exception','BSA TD','Paul SO SME ML','ML for Adjustment')
group by 1,2,3,4,5
order by 1,2,3;
...
and prodgrp not in ('Capital Benefit','Customer Margin Other','Non Customer Margin')
and reporting_mth in  ('201806','201807')
and manual_alloc_desc not in ('Bill Reclass Issue','BS Issue Prod Exception','BSA TD','Paul SO SME ML','ML for Adjustment')
group by 1,2,3,4,5
order by 1,2,3
