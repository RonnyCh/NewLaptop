...
where a.reporting_mth in ('201904')
and entry_code = 'ADJ'
and lg_product_id = '41403'
--and lg_account_id = '421100'
...
from dwpviewa.FQ_Adjusted_Ledger a
where lg_product_id = '41403'
--and lg_account_id = '421100'
and reporting_centre_id = '000000'
and reporting_mth = '201907'
...
,Reporting_Centre_ID           
,'99' as Alloc_Rule_Id                 
,'ML for Adjustment 41403 Exception' as Alloc_Description             
,-Metric_Amt                
from fq_alc
union all
select
...
,'99' as Alloc_Rule_Id                 
,'ML for Adjustment 41403 Exception'
...
and manual_alloc_desc = 'ML for Adjustment 41403 Exception';
